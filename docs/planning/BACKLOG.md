...
| STM-FACH-002 | Vollständigeres FIDE-Dutch-Schweizer-System | P1 | In Review | pairing | friend | [#22](https://github.com/Randspringer90/SchachTurnierManager/issues/22) (Original-PR [#40](https://github.com/Randspringer90/SchachTurnierManager/pull/40), sichere Adoption läuft; FIDE C.04.3-Fassung 2026 gegen Primärquelle bestätigt, 497 Tests grün; offen: WebApp-UI-Auswahl) | v1.0.0 |
