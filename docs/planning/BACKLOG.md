...
| STM-TB-001 | Buchholz / Buchholz-Cut / Sonneborn-Berger – Golden-Tests | P2 | **Ready** | tiebreaks | friend | [#2](https://github.com/Randspringer90/SchachTurnierManager/issues/2) | v1.0.0 |
