...
function Invoke-Step {
    ...
    Write-Host "[v0.10.0] $Name..." -ForegroundColor Cyan
    & $Script
...
Write-Host "[v0.10.0] Nachkontrolle abgeschlossen. Bitte danach git status prüfen und committen." -ForegroundColor Green
