...
function Invoke-Step {
    ...
    Write-Host "[v0.9] $Name..." -ForegroundColor Cyan
    & $Script
...
Write-Host "[v0.9] Nachkontrolle abgeschlossen. Bitte danach git status prüfen und committen." -ForegroundColor Green
