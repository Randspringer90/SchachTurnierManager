...
function Invoke-Step {
    ...
    Write-Host "[v0.9.1.1] $Name..." -ForegroundColor Cyan
    & $Script
...
Write-Host "[v0.9.1.1] Nachkontrolle abgeschlossen. Bitte danach git status prüfen und committen." -ForegroundColor Green
