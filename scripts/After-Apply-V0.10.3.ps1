...
function Invoke-Step {
    ...
    Write-Host "[v0.10.3] $Name..." -ForegroundColor Cyan
    & $Command
...
Write-Host '[v0.10.3] Nachkontrolle abgeschlossen. Bitte danach git status prüfen und committen.' -ForegroundColor Green
git status --short
