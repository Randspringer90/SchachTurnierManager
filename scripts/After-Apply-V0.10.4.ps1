...
function Invoke-Step {
    ...
    Write-Host "[v0.10.4] $Name..." -ForegroundColor Cyan
    & $Command
...
Write-Host '[v0.10.4] Nachkontrolle abgeschlossen. Bitte danach git status prüfen und committen.' -ForegroundColor Green
git status --short
