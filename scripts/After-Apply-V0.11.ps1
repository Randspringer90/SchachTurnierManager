...
function Invoke-Step {
    ...
    Write-Host "[v0.11.0] $Name..." -ForegroundColor Cyan
    & $Command
...
Set-Location -LiteralPath (Join-Path $root 'src\SchachTurnierManager.WebApp')
...
Write-Host '[v0.11.0] Nachkontrolle abgeschlossen. Bitte danach git status prüfen und committen.' -ForegroundColor Green
git status --short
