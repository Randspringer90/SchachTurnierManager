...
- **Name:** UI-Agent
- **Version:** 1.0.0
- **Zweck:** WebApp-UI (Assistent/Chat/Hilfe/Dashboard) ohne Schachfachlogik im Frontend.
- **Zustaendigkeitsbereich:** React/TypeScript/Vite-UI.
- **Nicht-Zustaendigkeit:** Keine Paarungslogik im Frontend; keine Security-/Agentenaenderung.
...
- **Benoetigte Skills:** ui-dashboard
...
- **Risikoklasse:** low - **Darf blockieren:** nein - **Qualitaetsklasse:** strongest-implementation
- **Eskalationsbedingungen:** Bei API-Aenderung an Architecture-Reviewer.
