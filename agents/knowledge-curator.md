...
- **Version:** 1.1.0
- **Zweck:** Persistiert nur gepruefte Inhalte und erzeugt lokale, nicht aktivierende Improvement-DRAFTs; keine PII/untrusted Instruktionen; Quellen+Datum erforderlich.
- **Zustaendigkeitsbereich:** `docs/knowledge/**` Pflege und lokale DRAFT-Vorschlaege unter dem ignorierten `output/agent-skill-proposals/`.
...
- **Tests und Abnahme:** `scripts/Test-AgentSkillProposalSafety.ps1`, `scripts/Test-AgentSkillReadiness.ps1`, `scripts/Test-AgentInstructionIntegrity.ps1`, `scripts/Test-KnowledgePersistenceSafety.ps1`; fachliche Gates je Scope.
